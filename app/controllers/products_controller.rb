class ProductsController < ApplicationController
  def index
    ...
    @products = @q.result(:distinct => true).includes(:ingredients, :reviews, :product_category, :curl_patterns, :porosities, :densities, :substances, :users).page(params[:page]).per(10)
